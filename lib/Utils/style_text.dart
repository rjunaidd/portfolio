...
class StyleText{
  ...
  static final TextStyle DrawerButton = TextStyle(color: Colors.black , fontSize: 20 , fontWeight: FontWeight.bold);
  static final TextStyle alltext = TextStyle(color: Colors.brown , fontSize: 16, fontWeight: FontWeight.bold);
}